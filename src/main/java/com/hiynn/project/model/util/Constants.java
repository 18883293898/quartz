...
public final class Constants {
	...
	public static final String DEFAULT＿INFO_VALUE = "0";
	public static final String USER_ID_PREFIX = "UserInfo@:";
	public static final String TABLE_HURSEID_HOURSEINFO = "HourseInfo@:";
	public static final String FEILD_ADDRESS_INFO = "Address";
	public static final String FEILD_SIZE_INFO = "Size";
	public static final String FEILD_TOILT_INFO = "ToiltInfo";
